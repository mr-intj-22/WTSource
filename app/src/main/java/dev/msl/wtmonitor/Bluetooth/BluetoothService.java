...
public class BluetoothService {
    // Debugging
    private final String TAG = "BluetoothChatService";
                        ...
                        switch (mState) {
                            ...
                            case STATE_CONNECTED:
                                ...
                                try {
                                    ...
                                    Toast.makeText(context, R.string.close_error, Toast.LENGTH_SHORT).show();
                                }
                                break;
                        }
                    }
                ...
                try {
                    ...
                    for(int i = begin; i < bytes; i++) {
                        if(buffer[i] == "#".getBytes()[0]) {
                            mHandler.obtainMessage(Const.MESSAGE_READ, begin, i, buffer).sendToTarget();
                            begin = i + 1;
                            if(i == bytes-1 || bytes > 5*1000) {
                                bytes = 0;
                                begin = 0;
                            }
                        }
